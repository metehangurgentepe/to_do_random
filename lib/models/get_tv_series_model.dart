class GetTvShowModel {
  ...
  late final List<num> episodeRunTime;
  ...
  late final num numberOfEpisodes;
  late final num numberOfSeasons;
  ...
  GetTvShowModel.fromJson(Map<String, dynamic> json){
    adult = json['adult'];
...
class LastEpisodeToAir {
  ...
  late final num episodeNumber;
  late final num id;
  late final String name;
  late final String overview;
  late final String productionCode;
  late final num runtime;
  late final num seasonNumber;
  late final num showId;
